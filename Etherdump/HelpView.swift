    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text(" ")
                    Group {Text("PackageEtherCapture").font(.headline) + Text(" for capturing and decoding Ethernet frames https://github.com/darrellroot/PackageEtherCapture")}.fixedSize(horizontal: false, vertical: true).lineLimit(2)
                }
                Group {
                Text("PackageSwiftPcapng https://github.com/darrellroot/PackageSwiftPcapng for opening and saving .pcap and .pcapng files")
                Text("Swift-Log API https://github.com/apple/swift-log")
                Text(" ")
                Text("We encourage feedback and answer questions at feedback@networkmom.net")
                Text(" ")
                }
                Group {
